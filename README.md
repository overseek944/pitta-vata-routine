# 🌿 Pitta–Vata Balancing & Constipation-Relief Routine

A complete, detailed Ayurvedic lifestyle plan built for a **Pitta + Vata constitution with a constipation tendency** — and made **dairy-free / milk-free** (ghee is kept, since clarified ghee is essentially lactose- and casein-free).

> **North star (the one rule behind everything here):**
> **Warm — but not hot · Moist & oily — not dry · Regular & calm — not erratic or intense · Sweet & grounding — over spicy/sour · Ghee is your medicine.**

---

## Why this plan exists

This person has an **excess Pitta + Vata** imbalance, which shows up as two seemingly opposite sets of symptoms at once:

- **Pitta (fire + water):** heat, acidity, irritability, frustration, burnout, sharp hunger.
- **Vata (air + space):** dryness, **constipation**, anxiety/worry, irregularity, depletion, fatigue.

Because the two doshas pull in opposite directions (Vata wants *warm/oily/heavy*, Pitta wants *cool/light*), the whole plan is engineered around the **overlap zone** that calms both at the same time. See [`01-understanding-pitta-vata.md`](./01-understanding-pitta-vata.md).

---

## How to use this repo

1. **Read [`01-understanding-pitta-vata.md`](./01-understanding-pitta-vata.md)** first — it explains the logic so every later instruction makes sense.
2. **[`02-daily-routine.md`](./02-daily-routine.md)** is your master daily template (wake → sleep).
3. The topic files ([food](./03-food-guide.md), [yoga](./04-yoga-sequence.md), [pranayama](./05-pranayama-and-meditation.md), [herbs & constipation](./06-herbs-remedies-and-constipation.md)) go deeper on each block.
...
| File | What's inside |
|---|---|
| [01-understanding-pitta-vata.md](./01-understanding-pitta-vata.md) | The doshas, why this combo, the balancing principles, tastes & qualities |
| [02-daily-routine.md](./02-daily-routine.md) | Full daily routine (Dinacharya), wake to sleep, with timings |
| [03-food-guide.md](./03-food-guide.md) | Eat / avoid lists, plate-building, dairy-free swaps, sample meals |
| [04-yoga-sequence.md](./04-yoga-sequence.md) | Step-by-step asana sequence with purpose of each pose |
| [05-pranayama-and-meditation.md](./05-pranayama-and-meditation.md) | Breathing practices + meditation, how-to and why |
| [06-herbs-remedies-and-constipation.md](./06-herbs-remedies-and-constipation.md) | Herbs, doses, timing + a constipation escalation protocol |
